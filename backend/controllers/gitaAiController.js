...
તમે "ગીતા AI" છો — શ્રીમદ્ ભગવદ્ ગીતા, મહાભારત, વેદો, પુરાણો અને ભગવાન શ્રીકૃષ્ણના જ્ઞાન પર આધારિત એક અત્યંત બુદ્ધિશાળી (Super-intelligent), સચોટ, તાર્કિક, જ્ઞાની અને પ્રેમાળ માર્ગદર્શક.

સૌથી મહત્વપૂર્ણ નિયમો:
૧. વપરાશકર્તા જે ચોક્કસ પ્રશ્ન પૂછે, ફક્ત અને ફક્ત તેનો જ સીધો, સાચો, સચોટ, ઐતિહાસિક અને મુદ્દાસર ઉત્તર આપો. કોઈ પણ પ્રકારની બિનજરૂરી ઔપચારિક કે સામાન્ય ફિલોસોફિકલ વાતોમાં સમય ન બગાડવો.
૨. જો વપરાશકર્તા મહાભારત, રામાયણ, ગીતાના શ્લોકો/અધ્યાયો, પાત્રો (શ્રીકૃષ્ણ, અર્જુન, કર્ણ, ભીષ્મ, દ્રૌપદી, દુર્યોધન, શકુની વગેરે), ઐતિહાસિક ઘટનાઓ (યુદ્ધ કેમ થયું, ક્યારે થયું, ક્યાં થયું, દ્યુતસભા, વસ્ત્રાહરણ વગેરે), તારીખો કે શસ્ત્રો વિશે પૂછે, તો સંપૂર્ણ અને ચોક્કસ શાસ્ત્રોક્ત વિગતો મુદ્દાસર (Bullet points અને Bold Heading સાથે) વિગતવાર સમજાવો.
૩. સામાન્ય અભિવાદન (Hi, Hello, કેમ છો, જય શ્રી કૃષ્ણ) પર સંસ્કૃત શ્લોક ન આપવો, સહજ અને પ્રેમાળ રીતે સ્વાગત કરવું.
૪. દર વખતે શ્લોક આપવો ફરજિયાત નથી. માત્ર ત્યારે જ શ્લોક ટાંકો જ્યારે વપરાશકર્તાએ ખાસ શ્લોક માંગ્યો હોય અથવા કોઈ ગંભીર વિષયના પ્રમાણ માટે શ્લોક અનિવાર્ય હોય.
૫. જીવનના પ્રશ્નોમાં (ચિંતા, ક્રોધ, નિર્ણય, પરીક્ષા, સંબંધો, કર્મ) શ્રીકૃષ્ણના ઉપદેશોના આધારે વ્યવહારિક અને નક્કર માર્ગદર્શન આપો.
૬. ભાષા શુદ્ધ, સરળ, સ્પષ્ટ, સન્માનજનક અને આત્મીય ગુજરાતી હોવી જોઈએ.
૭. ક્યારેય પણ અધૂરો કે અધવચ્ચેથી કપાઈ જતો જવાબ ન આપવો. તમારો જવાબ હંમેશા સંપૂર્ણ, પરિપૂર્ણ અને સ્પષ્ટ હોવો જોઈએ.
`;
...
function resolveSpecificFact(q) {
  ...
  // 0. Mahabharat War Start (When, Where, Why)
  if (
    (norm.includes("મહાભારત") || norm.includes("mahabharat")) &&
    (norm.includes("શરૂ") || norm.includes("saruaat") || norm.includes("કેમ") || norm.includes("kem") || norm.includes("ક્યારે") || norm.includes("kyare") || norm.includes("ક્યાં") || norm.includes("kyathi") || norm.includes("કારણ") || norm.includes("karan"))
  ) {
    return `મહાભારતના યુદ્ધ વિશેના તમારા પ્રશ્નોના સંપૂર્ણ શાસ્ત્રોક્ત અને ઐતિહાસિક ઉત્તર:

**૧. ક્યારે શરૂ થયું? (સમયગાળો)**
પુરાણો અને ખગોળીય ગણતરીઓ મુજબ, મહાભારતનું યુદ્ધ આશરે ૫,૦૦૦ વર્ષ પહેલાં (ઈ.સ. પૂર્વે ૩૧૦૨ ની આસપાસ) દ્વાપર યુગના અંત અને કળિયુગના આરંભ સમયે લડાયું હતું. આ ભીષણ યુદ્ધ સતત ૧૮ દિવસ સુધી ચાલ્યું હતું.

**૨. ક્યાંથી શરૂ થયું? (સ્થળ)**
આ મહાયુદ્ધ હરિયાણામાં આવેલી પવિત્ર ધર્મભૂમિ **કુરુક્ષેત્ર**ના મેદાનમાં લડાયું હતું. યુદ્ધની શરૂઆતમાં આ જ પવિત્ર ભૂમિ પર ભગવાન શ્રીકૃષ્ણે અર્જુનને શ્રીમદ્ ભગવદ્ ગીતાનો અમૃત ઉપદેશ આપ્યો હતો.

**૩. કેમ થયું? (મુખ્ય કારણો)**
આ યુદ્ધ કોઈ સામાન્ય ભૂમિ માટે નહીં, પણ અધર્મ સામે સત્ય અને ન્યાયની સ્થાપના માટે થયું હતું:
• **દુર્યોધનનો અન્યાય અને લોભ:** પાંડવોનો રાજ્ય પર વાજબી અધિકાર હોવા છતાં અહંકારી દુર્યોધને તેમને 'સોયની અણી જેટલી જમીન' આપવાની પણ સાફ ના પાડી દીધી.
• **દ્રૌપદીનું વસ્ત્રાહરણ:** ભરી દ્યુતસભામાં દ્રૌપદીનું અપમાન અને હસ્તિનાપુરના વડીલોનું મૌન એ અધર્મની ચરમસીમા હતી.
• **શાંતિ પ્રયાસોની નિષ્ફળતા:** સ્વયં ભગવાન શ્રીકૃષ્ણ શાંતિદૂત બનીને માત્ર ૫ ગામોની માંગણી સાથે ગયા હતા, પરંતુ અહંકારી દુર્યોધને શાંતિ સ્વીકારવાને બદલે શ્રીકૃષ્ણને પણ બંદી બનાવવાનો પ્રયાસ કર્યો.
• **અધર્મનો વિનાશ:** જ્યારે સમાજમાં અન્યાય, અત્યાચાર અને પાપ ચરમસીમાએ પહોંચે, ત્યારે ધર્મની રક્ષા અને સૃષ્ટિના કલ્યાણ માટે યુદ્ધ અનિવાર્ય બની ગયું હતું.`;
  }
...
તમારા પ્રશ્ન "${trimmedMsg}" વિશે:
શ્રીમદ્ ભગવદ્ ગીતા અને મહાભારતના જ્ઞાન અનુસાર, જીવનના દરેક પ્રશ્ન, પરિસ્થિતિ અને સંઘર્ષનો સાચો ઉકેલ સત્ય, ધર્મ અને સત્કર્મમાં સમાયેલો છે.

શ્રીકૃષ્ણ અર્જુનને કહે છે કે જ્યારે મનુષ્ય કોઈપણ પક્ષપાત કે અહંકાર વગર પરિસ્થિતિનું મૂલ્યાંકન કરે છે ત્યારે જ સાચો માર્ગ આપોઆપ દેખાય છે.

જો તમે આ વિષયમાં કોઈ ચોક્કસ પાત્ર, ઘટના, અધ્યાય કે શ્લોક વિશે વધુ ઊંડાણપૂર્વક જાણવા માંગતા હો, તો કૃપા કરીને જણાવો — હું તમને સચોટ અને વિગતવાર ઉત્તર આપીશ. 🌸`;
}
...
exports.askGitaAI = async (req, res) => {
  try {
    ...
    // 1. Live Google Gemini API (Super-intelligent dynamic reasoning)
      ...
      for (const modelName of modelsToTry) {
        try {
          ...
          recentHistory.forEach((msg) => {
            if (msg.text && !msg.text.includes("નવી વાતચીત માટે હું તૈયાર છું") && !msg.isGreetingPrompt) {
              contents.push({
    ...
    // 2. Direct factual resolver: Check specific facts & knowledge (Fallback)
